...
namespace Fiche_Reparation.Helpers
{
    public class PdfService
    {
        ...
        private string RenderViewToString(string viewName, object model, ControllerContext controllerContext)
        {
            ...
            {
                var viewContext = new ViewContext(actionContext, viewResult.View, viewDataDictionary, new TempDataDictionary(controllerContext.HttpContext, tempDataProvider), stringWriter, new HtmlHelperOptions()); viewResult.View.RenderAsync(viewContext).Wait();
